...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference("Venda.count") do
      post vendas_url, params: { venda: { data: @venda.data, descricao: @venda.descricao, user_id: @venda.user_id, valor: @venda.valor } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { data: @venda.data, descricao: @venda.descricao, user_id: @venda.user_id, valor: @venda.valor } }
